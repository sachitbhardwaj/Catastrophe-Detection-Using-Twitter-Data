...
#rbf
Model1 = svm.SVC(kernel='rbf') #rbf by default svm.SVC()
Model1.fit(X_train, y_train)
y_pred1 = Model1.predict(X_test)

print("rbf model Accuracy", accuracy_score(y_test, y_pred1))
print("rbf model Weighted Precision, Recall, F-Score & Support1")
...
print("Linear model Accuracy", accuracy_score(y_test, y_pred2))
print("Linear model Weighted Precision, Recall, F-Score & Support1")
